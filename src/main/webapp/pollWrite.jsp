...
//		투표 데이터가 넘어오지 않았으므로 오류 메시지를 출력하고 pollRead.jsp로 돌려보낸다. //	javascript
		out.println("<script>");
		out.println("alert('투표하세요!~~~~')");
		out.println("location.href='pollRead.jsp'");
		out.println("</script>");
		
//		하나의 jsp 파일에 서버용 스크립트(jsp)와 클라이언트 스크립트(javascript)를 모두 사용한   //	jsp
//		경우 코딩 순서와 무관하게 서버용 스크립트가 먼저 다 실행되고 난 후 클라이언트용 스크립트가 실행된다.
